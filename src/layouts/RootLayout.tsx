    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex w-full">
        <div className="flex flex-col gap-8 w-36">
          ...
          <NavLink to="/react-query" className={({ isActive }) => (isActive ? "text-orange-600" : "text-blue-400")}>
            React Query
          </NavLink>
          <NavLink to="/redux" className={({ isActive }) => (isActive ? "text-orange-600" : "text-blue-400")}>
            Redux
          </NavLink> */}

          <button className="btn" onClick={() => navigate("/", { state: "Hello" })}>
            Home
          </button>
